function [ph_unwrapped_exact, ph_der] = besselhPhaseUnwrapped(v, x)
%Calculates phase (and derivative) of besselh, but unwrapped.
%
% Author: Matt Dvorsky
...
yVal(isinf(yVal)) = -inf;   % Fix Matlab bug when x/v is small.
