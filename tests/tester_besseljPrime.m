classdef tester_besseljPrime < matlab.unittest.TestCase
    % Unit tests for "besseljPrime" function.
    %
    % Author: Matt Dvorsky
    ...
    properties
        ...
        besselFun = @(v, z, scale) besseljPrime(v, z, scale);
        expectedFun = @(v, z, scale) 0.5 * (besselj(v - 1, z, scale) ...
            - besselj(v + 1, z, scale));
    end
