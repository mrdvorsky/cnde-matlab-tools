classdef tester_besselCylinderPrime < matlab.unittest.TestCase
    % Unit tests for "besselCylinderPrime" function.
    %
    % Author: Matt Dvorsky
    ...
    properties
        ...
        besselFun = @(v, t, z, scale) besselCylinderPrime(v, t, z, scale);
        expectedFun = @(v, t, z, scale) real(t).*besseljPrime(v, z, scale) ...
            + imag(t).*besselyPrime(v, z, scale);
    end
    ...
    methods (Test)
        ...
        function test_randomValuesT0(testCase)
            ...
            % Test with t = 1, should be equivalent to besseljPrime
