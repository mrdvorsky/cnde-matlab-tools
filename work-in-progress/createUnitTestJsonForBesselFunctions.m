...
funStrings = [...
    ...
    ...
    "@(n, z) besseljy(0, n, z)", ...
    "@(n, z) besseljy(0, n, z, true)", ...
    "@(n, z) besseljy(pi/2, n, z)", ...
    "@(n, z) besseljy(pi/2, n, z, true)", ...
    "@(n, z) besseljy(1, n, z)", ...
    "@(n, z) besseljy(1, n, z, true)", ...
    ...
    "@(n, z) besseljyPrime(0, n, z)", ...
    "@(n, z) besseljyPrime(0, n, z, true)", ...
    "@(n, z) besseljyPrime(pi/2, n, z)", ...
    "@(n, z) besseljyPrime(pi/2, n, z, true)", ...
    "@(n, z) besseljyPrime(1, n, z)", ...
    "@(n, z) besseljyPrime(1, n, z, true)", ...
    ];
